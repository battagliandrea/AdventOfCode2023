package it.battagliandrea.advent.of.code.day2

import it.battagliandrea.advent.of.code.day2.models.Game
...
private fun part1(){
    val output = Game.createFromFileName("puzzle_input_02_1.txt")
...
private fun part2(){
    val output = Game.createFromFileName("puzzle_input_02_2.txt")
        .sumOf { it.getPower() }
